...
if (themeSelector) {
    ...
    function selectChange(value){
        ...
        if (theme != 'default') {
            ...
            require(['/assets/e-chart/theme/' + theme], function(tarTheme){
                curTheme = tarTheme;
...
if (developMode) {
    ...
    (function () {
        ...
        script.src = '/assets/e-chart/asset/js/esl/esl.js';
...
function launchExample() {
    ...
    require(
        [
            'echarts',
            '/assets/e-chart/theme/' + hash.replace('-en', ''),
            'echarts/chart/line',
            'echarts/chart/bar',
